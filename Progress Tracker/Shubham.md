...
Train time: 14h 4m 8s

G_L1 : started at around 45. logarithmic decay to about 12.5
...
Train time: 21h 16m 10s

G_L1 : started at around 42. almost linear noisy decay upto 20
G_GAN: statrted noisily at 2.5, then noisily exploded and grew to around 17.5
...
```
 Dataset : 9.5k cleaned flower images  (total dataset of 12.5k images)
 Training Environment : Core i9 12900 + 32GB + NVIDIA A2000 12GB
 Framework : PyTorch (Pix2Pix implementation)  
 Total Experiments : 15 model variants (+sweep with 21 configurations)
 Total Training Time : ~150 GPU hours (+75h sweep)
```
